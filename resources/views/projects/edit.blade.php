            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="{{ route('update.project',$project) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputEmail3"  name="name" value="{{ old('name', $project->name) }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="col-sm-10">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" name="is_active"  type="checkbox" role="switch"
                                        id="flexSwitchCheckDefault" value="1" @if(old('is_active',$project->is_active)) 
                                        checked 
                                    @endif >
