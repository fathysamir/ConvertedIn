...
<head>
    ...
    <link href="{{asset('darkpan/all.min.css')}}" rel="stylesheet">
    <link href="{{asset('darkpan/bootstrap-icons.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{asset('darkpan/bootstrap.bundle.min.js')}}"></script>
